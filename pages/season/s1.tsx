...
const Page: React.FC<IProps> = ({ photoNames }) => {
  return (
    <MainLayout>
      <Head>
        <title>Season 1 - DeltaCraft</title>
      </Head>
      <Jumbotron imageUri="jumbotrons/Banner1.webp">
        <div className="d-flex justify-content-center justify-content-md-end align-items-center align-items-md-end h-100 mt-4 p-5">
          <div className="text-white text-md-end font-delta">
            <p>
              <img src="/img/logos/S1-White.webp" className="logo-img" />
            </p>
        ...
        <div className="mask" style={{ backgroundColor: "rgba(0,0,0,0)" }}>
          <div className="d-flex justify-content-center align-items-center h-100">
            <div className="text-black">
              <h1 className="mb-3 mt-5 pt-4">Vaše stavby</h1>
            </div>
          </div>
        </div>
      </div>
